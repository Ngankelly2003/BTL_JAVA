...
public class AccountDao {
    ...
    // Add Guide account
    public void addGuideAccount(String username, String password, String role){
        String sql = "INSERT INTO tbl_account (username,password,role) VALUES (?,?,?)";
        try {
...
//            preparedStatement.setInt(1, account.getId());
            ...
            int addRows = preparedStatement.executeUpdate();
            if(addRows > 0){
                System.out.println("Add account Guide successful!");
            }else{
                System.out.println("Add account Guide false!");
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public void addCustomerAccount(String username, String password, String role){
        String sql = "INSERT INTO tbl_account (username,password,role) VALUES (?,?,?)";
        try {
            Account account = new Account(username, password, role);
            Connection connection = JDBCUtil.getConnection();
...
//            preparedStatement.setInt(1, account.getId());
            ...
            int addRows = preparedStatement.executeUpdate();
            if(addRows > 0){
                System.out.println("Add account Customer successful!");
            }else{
                System.out.println("Add account Customer false!");
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
